"""
Jira Sync Scheduler Lambda for OutcomeOps AI Assist.

Triggered hourly by EventBridge to fan out sync jobs for all active
Jira connections. Each connection gets a message in the sync queue.

This enables incremental syncs - only issues modified since last sync
are processed.
"""
